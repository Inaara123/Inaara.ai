...
const OurApps = () => {
    ...
    return (
        <div className='h-[180vh] mt-20 flex flex-col gap-2 items-center justify-center'>
            ...
            <div className='px-20 mt-10 h-full w-full  grid grid-flow-row grid-cols-3 grid-rows-4 gap-4'>
                ...
                <div className='w-full author-medium'>
                    <h1 className=' author-semibold text-3xl mb-4 author-semibold'>Enter your details</h1>
                    <input
                    type='text'
                    placeholder='Name'
                    value={name}
                ...
                <div className='col-span-2 row-span-2 border-2 border-gray-600 rounded-3xl flex items-center justify-center'>
